...
def test_simple_inline_equation_html(tmpdir):
    ...
    assert eq.src_filepath == 'media/0740ed673b.tex'
    ...
    assert root_html == ('<img class="eq" '
                         'src="/media/0740ed673b_crop_scale1.0.svg"/>')
    assert tmpdir.ensure(settings.media_dir, '0740ed673b_crop_scale1.0.svg')
    assert tmpdir.ensure('.html', settings.media_dir,
                         '690740ed673b_crop_scale1.0.svg')
