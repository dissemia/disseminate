...
def test_group_paragraphs_with_tags(context_cls):
...
def test_assign_paragraph_with_tags(context_cls):
...
def test_process_paragraph_tags(context_cls):
...
def test_process_paragraph_tags_leading_spaces(context_cls):
...
def test_process_paragraphs_in_context(context_cls):
    ...
    context = context_cls(process_paragraphs=['body'])
