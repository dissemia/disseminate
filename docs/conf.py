...
# -*- coding: utf-8 -*-
#
# disseminate documentation build configuration file, created by
...
htmlhelp_basename = 'disseminatedoc'
...
latex_documents = [
    (master_doc, 'disseminate.tex', 'disseminate Documentation',
     'Justin L Lorieau', 'manual'),
]
...
man_pages = [
    (master_doc, 'disseminate', 'disseminate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'disseminate', 'disseminate Documentation',
     author, 'disseminate', 'One line description of project.',
     'Miscellaneous'),
]
