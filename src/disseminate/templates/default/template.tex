...
\newtcolorbox{featurebox}{colback=black!5!white, colframe=black!40!white}
\newtcolorbox{examplebox}{colback=blue!5!white, colframe=blue!40!white}

{%- endblock %}
{%- block pygmentsheader %}
{%- raw %}
\usepackage{fancyvrb}
